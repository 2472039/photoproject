...
SECRET_KEY = 'django-insecure-=l%d7n5$jdd6=7ukp8k7nrd=9i=x(x^2p#n_^no5qkbxp76-&4'
...
# DEFAULT_FROM_EMAIL = 'ryubi2197@gmail.com'  # メールの送信元のアドレス
# EMAIL_HOST = 'smtp.gmail.com'               # GmailのSMTPサーバー
# EMAIL_PORT = 587                            # SMTPサーバーのポート番号
# EMAIL_HOST_USER = 'ryubi2197@gmail.com'     # Gamilのアドレス
# EMAIL_HOST_PASSWORD = 'xooc rekn txib rcls' # Gmailのアプリ用パスワード
